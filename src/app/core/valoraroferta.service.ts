...
export class ValorarofertaService {
  ...
  ConsultaSeguimientoEntregas(Bandera: string, IdGrupo: string) {
    return this.http.get<any[]>(this.url_servidor + 'consSeguimientoEntregas/' + Bandera + '/' + IdGrupo)
  }
  ...
  ConsultaReporteEntregas(Bandera: string, IdGrupoMilla: string) {
    return this.http.get<any[]>(this.url_servidor + 'consRepEstEntrega/' + Bandera + '/' + IdGrupoMilla)
  }
